...
import 'package:multipurpose_security_system/Model/Temperature/TemperatureListApi.dart';
...
class _TemperatureListPageState extends State<TemperatureListPage> {
  ...
  TemperatureListApi temperatureListApi;

  Future<List<dynamic>> getTemperature() async {

    final response = await http.get(
      'https://securitsys.000webhostapp.com/flutterdata/tempsensordata.php',
    );
    temperatureListApi = new TemperatureListApi.fromJsonMap(json.decode(response.body.toString()));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:  _isLoading ? Center(child: CircularProgressIndicator()) : ListView.builder(
          shrinkWrap: true,
          itemCount: temperatureListApi.temp.length,
                    ...
                    Padding(
                      ...
                      child:Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child:  Text(temperatureListApi.temp[index].temp_value),
                          ),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child:Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child:  Text(temperatureListApi.temp[index].reading_time),
                          ),
                        ],
                      ),
                    ),
